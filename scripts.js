...
function loadInstagramFeed() {
    ...
    .then(data => {
        // For hvert billede i dataen, opret et img-element og tilføj det til feedet
...
function loadFacebookFeed() {
    ...
    fetch('https://graph.facebook.com/' + pageId + '/posts?fields=message,created_time&access_token=' + accessToken)
    .then(response => response.json())
    .then(data => {
        // For hvert opslag i dataen, opret et p-element og tilføj det til feedet
        data.data.forEach(post => {
